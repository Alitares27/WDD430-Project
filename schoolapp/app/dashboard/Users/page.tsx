...
export default function UsersPage() {
  ...
  const [sessionUser, setSessionUser] = useState<Users | null>(null);
    ...
    <div className="container mx-auto p-4">
      ...
      {sessionUser ? (
        <div className="max-w-sm mx-auto">
          <UserCard
            user={sessionUser}
            onViewDetails={() => handleViewDetails(sessionUser.user_id)}
            onEdit={() => handleEdit(sessionUser.user_id)}
            onDelete={() => handleDelete(sessionUser.user_id)}
          />
        </div>
      ) : (
        <>
