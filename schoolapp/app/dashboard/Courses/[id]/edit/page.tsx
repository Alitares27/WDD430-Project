...
export default function EditCoursePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (session?.user?.role !== 'admin') {
      alert("Access denied. You do not have permission to update courses.");
      return;
    }
  ...
  if (session?.user?.role !== 'admin') {
    return (
      <div className="container mx-auto p-4 text-center text-red-600">
        ...
        <p>You do not have permission to edit courses.</p>
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {formErrors.submit && (
          <p className="text-red-600 text-center mt-2">{formErrors.submit}</p>
        )}
        ...
        <div className="flex justify-end gap-4 mt-8">
          ...
          <Button type="submit" variant='primary' disabled={saving} className="w-full md:w-auto">
